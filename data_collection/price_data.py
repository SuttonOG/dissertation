...
def get_price_extracted_data(ticker: str = "NVDA",
                     ...
                     end_date: Optional[str] = None) -> Optional[pd.extracted_dataFrame]:
    ...
    try:
        ...
        # compute log returns (often preferred in financial analysis)
        ...
        # trim to the actual requested period (remove the buffer days)
        if not start_date:
